...
const HomeScreen = () => {
    ...
    const specialities = [
        { id: '1', name: 'Cardiology', image: require('../assets/registerGraphic.png') },
        { id: '2', name: 'Pediatrics', image: require('../assets/registerGraphic.png') },
        { id: '3', name: 'General Physician', image: require('../assets/registerGraphic.png') },
        { id: '4', name: 'Gastrology', image: require('../assets/registerGraphic.png') },
    ];
...
const styles = StyleSheet.create({
    fullHeader: {
        ...
        paddingBottom: width * 0.12, // Adjusted for a smaller header
    ...
    hospitalContainer: {
        ...
        borderRadius: 15,
        overflow: 'hidden',
        marginBottom: width * 0.04, // Adjusted for smaller spacing
        shadowColor: '#000',
        shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.1,
        shadowRadius: 3,
    ...
    hospitalImage: {
        width: '100%',
        height: width * 0.45, // Decreased height for smaller containers
    ...
    hospitalInfo: {
        padding: width * 0.03, // Adjusted padding for smaller container
    },
    hospitalName: {
